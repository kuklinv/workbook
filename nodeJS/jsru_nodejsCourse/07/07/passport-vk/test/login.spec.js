...
describe('passport-vkontakte tests', () => {
  ...
  it('should login user using facebook', async () => {
    ...
    await page.type("input[name*='email']", config.get('providers.vkontakte.test.login'));
    await page.type("input[name*='pass']", config.get('providers.vkontakte.test.password'));

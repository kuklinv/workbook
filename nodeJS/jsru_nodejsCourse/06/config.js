module.exports = {
  ...
  providers: {
    ...
    vkontakte: {
      app_id: process.env.VKONTAKTE_APP_ID || '7170818',
      app_secret: process.env.VKONTAKTE_APP_SECRET || 'sQFOLgbzrKifMPUhRP4C',
      callback_uri: 'http://localhost:3000/api/login/vkontakte/callback',
      options: {
        scope: ['email'],
      },
    },
